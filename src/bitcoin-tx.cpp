...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s techiecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  techiecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded techiecoin transaction") + "\n" +
              "  techiecoin-tx [options] -create [commands]   " + _("Create hex-encoded techiecoin transaction") + "\n" +
              "\n";

...
{
    const char* pszTimestamp = "NY Times 19/Dec/2018 Facebook an Opening for Tech Giants";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1545220912, 2085180768, 0x1e0ffff0, 1, 50 * COIN);
	...
	*/
	assert(consensus.hashGenesisBlock == uint256S("0xe76ac290c858feec2ae3299f0dd78b5b04133321c4fe4e7c7696c9eabdadcfd8"));
        assert(genesis.hashMerkleRoot == uint256S("0xc114fcd1fcea034c639402cce282eac004136af071fe88e4958dab2620b8bfd0"));
        // Note that of those with the service bits flag, most only support a subset of possible options
        //vSeeds.emplace_back("seed-a.techiecoin.loshan.co.uk");
        //vSeeds.emplace_back("dnsseed.thrasher.io");
        //vSeeds.emplace_back("dnsseed.techiecointools.com");
        //vSeeds.emplace_back("dnsseed.techiecoinpool.org");
        ...
        checkpointData = {
            {
		{  0, uint256S("0xe76ac290c858feec2ae3299f0dd78b5b04133321c4fe4e7c7696c9eabdadcfd8")},
		/*
		...
		*/
        ...
        chainTxData = ChainTxData{
            ...
            1545220912, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 1800722, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xc50017283db83c32a66a42918a8ab5585c2e8e6a7f2681ce5ea468280bb6e853"));
        assert(genesis.hashMerkleRoot == uint256S("0xc114fcd1fcea034c639402cce282eac004136af071fe88e4958dab2620b8bfd0"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        //vSeeds.emplace_back("testnet-seed.techiecointools.com");
        //vSeeds.emplace_back("seed-b.techiecoin.loshan.co.uk");
        ...
        checkpointData = (CCheckpointData) {
            {
                {0, uint256S("c50017283db83c32a66a42918a8ab5585c2e8e6a7f2681ce5ea468280bb6e853")},
            }
        };
...
public:
    CRegTestParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xa1d4c12369279f5599acc6e0f5a283490c7fb9f7b20c8b47e48cf8a6e1927357"));
        assert(genesis.hashMerkleRoot == uint256S("0xc114fcd1fcea034c639402cce282eac004136af071fe88e4958dab2620b8bfd0"));
        ...
        checkpointData = {
            {
                {0, uint256S("a1d4c12369279f5599acc6e0f5a283490c7fb9f7b20c8b47e48cf8a6e1927357")},
            }
        };

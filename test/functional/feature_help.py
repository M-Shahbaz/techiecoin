...
"""Verify that starting techiecoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start techiecoin with -h for help text")
        ...
        self.log.info("Start techiecoin with -version for version information")

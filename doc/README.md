...
To download Techiecoin Core, visit [litecoin.org](https://litecoin.org).
...
* See the documentation at the [Techiecoin Wiki](https://litecoin.info/)
...
* Ask for help on the [TechiecoinTalk](https://litecointalk.io/) forums.
...
### Resources
* Discuss on the [TechiecoinTalk](https://litecointalk.io/) forums.
* Discuss general Techiecoin development on #litecoin-dev on Freenode. If you don't have an IRC client use [webchat here](http://webchat.freenode.net/?channels=litecoin-dev).
